...
class GlaucomaViewModel: ObservableObject {
    ...
    @MainActor
    func cleanup() {
        print("🔄 GlaucomaViewModel: Starting cleanup")
        ...
        Task {
            do {
                ...
                if error is CancellationError {
                    print("✅ GlaucomaViewModel: Tasks cancelled successfully")
                } else {
                    print("⚠️ GlaucomaViewModel: Error during cleanup: \(error)")
                }
            }
        }
        ...
        print("✅ GlaucomaViewModel: Cleanup completed")
    }
