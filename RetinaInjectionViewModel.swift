...
class RetinaInjectionViewModel: ObservableObject {
    ...
    @MainActor
    func cleanup() {
        print("🔄 RetinaInjectionViewModel: Starting cleanup")
        ...
        Task {
            do {
                ...
                if error is CancellationError {
                    print("✅ RetinaInjectionViewModel: Tasks cancelled successfully")
                } else {
                    print("⚠️ RetinaInjectionViewModel: Error during cleanup: \(error)")
                }
            }
        }
        ...
        print("✅ RetinaInjectionViewModel: Cleanup completed")
    }
